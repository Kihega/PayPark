...
function makeStyles(C: ReturnType<typeof palette>) {
  return StyleSheet.create({
    ...
    sbAvatarText:{ color:'#fff', fontWeight:'900', fontSize: moderateScale(18) },
    sbName:{ fontSize: moderateScale(14), fontWeight:'800', color:'#F9FAFB' },
    sbRole:{ fontSize: moderateScale(11), color:'#9CA3AF', marginTop:1 },
    ...
    sbRowLabel:{ flex:1, fontSize: moderateScale(14), color:'#D1D5DB', fontWeight:'600' },
    sbRowRight:{ flexDirection:'row', alignItems:'center', gap:6 },
    sbRowValue:{ fontSize: moderateScale(12), color:'#9CA3AF' },
    ...
    sbDropText:{ fontSize: moderateScale(13), fontWeight:'600', color:'#D1D5DB' },
    ...
    sbLogoutText:{ color:'#EF4444', fontWeight:'700', fontSize: moderateScale(15) },
    // Logout modal
    ...
    logoutCardTitle:{ fontSize: moderateScale(20), fontWeight:'900', marginBottom:8 },
    logoutCardMsg:{ fontSize: moderateScale(14), textAlign:'center', lineHeight:21, marginBottom:24 },
    logoutBtnRow:{ flexDirection:'row', gap:12, width:'100%' },
    logoutCancelBtn:{ flex:1, height:48, borderRadius:12, borderWidth:1.5,
      alignItems:'center', justifyContent:'center' },
    logoutCancelText:{ fontWeight:'600', fontSize: moderateScale(14) },
    logoutConfirmBtn:{ flex:1, height:48, borderRadius:12, backgroundColor:'#EF4444',
      flexDirection:'row', alignItems:'center', justifyContent:'center', gap:8 },
    logoutConfirmText:{ color:'#fff', fontWeight:'800', fontSize: moderateScale(14) },
    // Top bar
    topBar:{ flexDirection:'row', alignItems:'center', justifyContent:'space-between',
      paddingHorizontal:16, paddingVertical:12 },
    topLogo:{ fontSize: moderateScale(22), fontWeight:'900', letterSpacing:0.5 },
    iconBtn:{ padding:4 },
    body:{ padding:16 },
    // Session
    ...
    sessionLabel:{ fontSize: moderateScale(11), color:'#cfffdf', fontWeight:'600',
      textTransform:'uppercase', letterSpacing:1, marginBottom:4 },
    sessionName:{ fontSize: moderateScale(18), fontWeight:'800', color:'#fff', marginBottom:2 },
    sessionZone:{ fontSize: moderateScale(13), color:'#cfffdf' },
    sessionDate:{ fontSize: moderateScale(12), color:'rgba(255,255,255,0.6)', marginTop:12 },
    ...
    dutyText:{ color:'#fff', fontSize: moderateScale(11), fontWeight:'800', letterSpacing:0.5 },
    // Stats
    statsRow:{ flexDirection:'row', gap:12, marginBottom:14 },
    statCard:{ flex:1, borderRadius:14, padding:16, alignItems:'center', gap:6,
      shadowColor:'#000', shadowOffset:{width:0,height:2},
      shadowOpacity:0.06, shadowRadius:6, elevation:3 },
    statVal:{ fontSize: moderateScale(24), fontWeight:'800' },
    statLabel:{ fontSize: moderateScale(11), textAlign:'center', fontWeight:'600' },
    ...
    ctaText:{ fontSize: moderateScale(15), fontWeight:'800', color:'#1A1A1A', letterSpacing:0.3 },
    sectionRow:{ flexDirection:'row', justifyContent:'space-between',
      alignItems:'center', marginBottom:10 },
    sectionTitle:{ fontSize: moderateScale(16), fontWeight:'800' },
    viewAll:{ fontSize: moderateScale(13), fontWeight:'600' },
    ...
    billPlate:{ fontSize: moderateScale(15), fontWeight:'700' },
    billMeta:{ fontSize: moderateScale(12), marginTop:2 },
    statusBadge:{ paddingHorizontal:10, paddingVertical:4, borderRadius:20 },
    badgePaid:{ backgroundColor:'rgba(30,181,58,0.12)' },
    badgePending:{ backgroundColor:'rgba(252,209,22,0.2)' },
    statusText:{ fontSize: moderateScale(10), fontWeight:'800', letterSpacing:0.5, color:'#1A1A1A' },
    tabBar:{ flexDirection:'row', borderTopWidth:1, paddingBottom:6, paddingTop:8 },
    tabItem:{ flex:1, alignItems:'center', gap:3 },
    tabLabel:{ fontSize: moderateScale(10), fontWeight:'600' },
  });
}
