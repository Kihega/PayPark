      ...
      {sidebarOpen && (
        <Modal transparent animationType="none" visible onRequestClose={closeSidebar}>
          ...
          <Animated.View style={[S.sidebar, { backgroundColor: '#111827',
            ...
            {/* Navigate items */}
            {[
              { icon: 'people-outline' as const, label: 'Manage Attendants',
                sub: 'Attendant management', onPress: () => closeSidebar() },
              { icon: 'car-outline' as const, label: 'Manage Vehicles',
                sub: 'Vehicle management',
        ...
        <View style={S.modalCenter}>
          <View style={[S.logoutCard, { backgroundColor: C.card }]}>
            ...
            <Text style={[S.logoutMsg,   { color: C.textSub }]}>
              Remove attendant <Text style={{ fontWeight: '800', color: C.text }}>{removeTarget?.fullName}</Text> from the system?
            </Text>
            <View style={S.logoutBtnRow}>
              <TouchableOpacity style={[S.cancelBtn, { borderColor: C.border }]}
...
const styles = StyleSheet.create({
  ...
  sbTitle:{ flex:1, fontSize: moderateScale(17), fontWeight:'800', color:'#F9FAFB' },
  ...
  sbNavLabel:{ fontSize: moderateScale(14), fontWeight:'700', color:'#F9FAFB' },
  sbNavSub:{ fontSize: moderateScale(11), color:'#6B7280', marginTop:1 },
  ...
  logoutTitle:{ fontSize: moderateScale(20), fontWeight:'900', marginBottom:8 },
  logoutMsg:{ fontSize: moderateScale(14), textAlign:'center', lineHeight:21, marginBottom:24 },
  ...
  confirmLogoutText:{ color:'#fff', fontWeight:'800', fontSize: moderateScale(14) },
  ...
  emptyText:{ fontSize: moderateScale(15) },
  ...
  roleText:{ fontSize: moderateScale(10), color:'#fff', fontWeight:'700' },
  name:{ fontSize: moderateScale(15), fontWeight:'700', marginBottom:2 },
  meta:{ fontSize: moderateScale(12), marginTop:1 },
