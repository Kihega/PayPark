...
function makeStyles(C: ReturnType<typeof palette>) {
  return StyleSheet.create({
    ...
    unreadText: { fontSize: 10, fontWeight: '800', color: '#1A1A1A' },
    ...
    typeBadgeText: { fontSize: 9, fontWeight: '900', letterSpacing: 1, textTransform: 'uppercase' },
    ...
    detailLabel: { width: 75, fontSize: 11, fontWeight: '600' },
    detailVal: { flex: 1, fontSize: 11, fontWeight: '700' },
    allowRow: { flexDirection: 'row', alignItems: 'center', gap: 6,
      paddingTop: 6, borderTopWidth: 1, marginTop: 2 },
    allowText: { flex: 1, fontSize: 11, fontWeight: '700', lineHeight: 16 },
  });
}
