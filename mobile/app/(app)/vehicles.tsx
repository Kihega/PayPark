...
const successStyles = StyleSheet.create({
  ...
  title:{ fontSize: moderateScale(22), fontWeight:'900', marginBottom:12 },
  ...
  plateBig:{ fontSize: moderateScale(24), fontWeight:'900', letterSpacing:4, color:'#1A1A1A' },
  sub:{ fontSize: moderateScale(14), textAlign:'center', lineHeight:21, marginBottom:14 },
  ...
  noteText:{ flex:1, fontSize: moderateScale(12), lineHeight:18 },
...
function makeStyles(C: ReturnType<typeof palette>) {
  return StyleSheet.create({
    ...
    plateChipText:{ fontSize: moderateScale(18), fontWeight:'900', letterSpacing:3 },
    cardBody:{ flexDirection:'row', alignItems:'flex-start' },
    ownerName:{ fontSize: moderateScale(15), fontWeight:'700', marginBottom:3 },
    ownerPhone:{ fontSize: moderateScale(12), marginBottom:6 },
    tagRow:{ flexDirection:'row', gap:6, flexWrap:'wrap' },
    catTag:{ paddingHorizontal:8, paddingVertical:3, borderRadius:20 },
    catTagText:{ fontSize: moderateScale(10), fontWeight:'700' },
    ...
    hintSmall:{ fontSize: moderateScale(11), marginTop:5 },
    ...
    catChipText:{ fontSize: moderateScale(12), fontWeight:'600', color: SprintColors.green },
    ...
    infoNoteText:{ flex:1, fontSize: moderateScale(12) },
    saveBtn:{ height:54, backgroundColor: SprintColors.green, borderRadius:12,
      alignItems:'center', justifyContent:'center', flexDirection:'row', gap:10 },
    saveBtnText:{ color:'#fff', fontSize: moderateScale(15), fontWeight:'900' },
  });
}
