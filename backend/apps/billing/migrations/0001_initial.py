    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['plate_number', 'status', 'expires_at'], name='billing_con_plate_n_aee46b_idx'), models.Index(fields=['officer', 'generated_at'], name='billing_con_officer_d77147_idx'), models.Index(fields=['status', 'expires_at'], name='billing_con_status_9da550_idx')],
            },
        ),
    ]
