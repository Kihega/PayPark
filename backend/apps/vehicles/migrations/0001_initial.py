...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('plate_number', models.CharField(db_index=True, help_text='Normalised to UPPERCASE, no spaces.', max_length=20, unique=True)),
                ('owner_name', models.CharField(max_length=150)),
                ('owner_phone', models.CharField(help_text='Must be a valid Tanzanian mobile number (+255...).', max_length=20)),
                ...
                ('category', models.CharField(choices=[('MOTORCYCLE', 'Motorcycle / Bajaj'), ('PRIVATE_CAR', 'Private Car'), ('MINIBUS', 'Minibus (Daladala)'), ('BUS', 'Bus / Coach'), ('TRUCK', 'Truck / Lorry'), ('GOVERNMENT', 'Government Vehicle')], default='PRIVATE_CAR', max_length=20)),
                ('registration_date', models.DateField(blank=True, null=True)),
                ('is_valid', models.BooleanField(default=True, help_text='False = unregistered, stolen, or flagged.')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
            ],
            options={
