...
class OfficerAdmin(UserAdmin):
    ...
    list_display = ["employee_id", "full_name",
                    "role", "location", "is_active", "created_at"]
...
class AuditLogAdmin(admin.ModelAdmin):
    list_display = ["timestamp", "officer", "action",
                    "plate_number", "control_number", "result", "ip_address"]
    list_filter = ["action", "result"]
    search_fields = ["officer__employee_id",
                     "plate_number", "control_number", "ip_address"]
